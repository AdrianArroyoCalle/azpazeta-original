...
Golf::Golf() : wxDialog(NULL, wxID_ANY, wxT("Valladolid Golf"), wxPoint(-1,-1), wxSize(400,400))
{
	...
	wxButton* comprarlujo=new wxButton(golfpanel, ID_COMPRARLUJO, "Comprar lujo", wxPoint(150, 200));
	wxButton* venderdroga=new wxButton(golfpanel, ID_VENDERDROGA, "Vender otras cosas", wxPoint(50,300));
	wxButton* valladolid=new wxButton(golfpanel, ID_VALLADOLID, "Hablar con ancianos",wxPoint(150,300));
