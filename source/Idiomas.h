//#ifndef IDIOMAS_H
//#define IDIOMAS_H
//Sistema de compilación separada por idiomas
#if IDIOMA == ES
//Español
#define CAP1MIS1TEX1 "Quien eres?\nNo te conozco.\nEres el nuevo?\nPresiona ENTER"
#define GO "Ir"
#define ERROR_101 "El archivo no existe o es corrupto"
#define DKEY_101 "Esta es la tienda de Azpazeta\nAqui podras comprar extras y trucos\nPero para eso necesitas\nrellenar la encuesta y obtener\nla clave Divel Key\nLa encuesta es anonima\ny solo sirve para\nconocer mejor al usuario\n"
